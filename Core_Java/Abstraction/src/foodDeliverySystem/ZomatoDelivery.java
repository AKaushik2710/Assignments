...
public class ZomatoDelivery implements FoodDelivery{
	int orderId;
	String restaurantName;
	double price;
	OrderState status;
	boolean isCancelled;
	ZomatoDelivery(int id, double price, String name, OrderState status){
		this.orderId = id;
		this.price = price;
	...
	public void placeOrder(String item, int quantity) {
		double finalPrice = this.price*quantity + 8;
